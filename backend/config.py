# -*- coding: utf-8 -*-
"""
auto_geo 后端配置 - 云端生产对齐版
已同步 n8n 云端 Webhook 地址：https://n8n.opencaio.cn
"""
...
ENCRYPTION_KEY = os.getenv(
    ...
    "auto-geo-default-key-32-bytes-length!!"
).encode()[:32]
